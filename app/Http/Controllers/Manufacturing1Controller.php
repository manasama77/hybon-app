...
class Manufacturing1Controller extends Controller
{
    ...
    public function store_material(Request $request)
    {
        try {
            ...
            $revisi_manufacturing_1 = $sales_order->revisi_manufacturing_1;
            ...
            if ($revisi_manufacturing_1 > 0) {
                $notes = "Revisi $revisi_manufacturing_1";
            }
            ...
            $exec->notes          = $notes;
            $exec->phase_seq      = 1;
            $exec->revisi_seq     = $revisi_manufacturing_1;
