    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form-edit').on('submit', e => {
                ...
                $.ajax({
                    url: `/manufacturing-2/update/${temp_sales_order_id}`,
                    method: 'post',
                    dataType: 'json',
                    data: formData,
                    processData: false,
        ...
        function askMove(id) {
            Swal.fire({
                title: 'Pindah Data?',
                text: "Anda yakin ingin memindahkan data ini ke Manufacturing Phase 3?",
                icon: 'question',
        ...
        function processMove(id) {
            $.ajax({
                url: "/sales-order/move/manufacturing-3/" + id,
                method: "POST",
                beforeSend: function() {
                    $.blockUI({
                        message: '<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>',
                ...
                if (e.success) {
                    Swal.fire(
                        ...
                        if (result.isConfirmed) {
                            window.location = "{{ route('manufacturing-2') }}"
                        }
                    })
                } else {
                    Swal.fire(
        ...
        function showEdit(id) {
            ...
            $.ajax({
                ...
                if (e.data.photo_manufacturing_2) {
                    console.log(e.data.photo_manufacturing_2)
                    $('.img-thumbnail').attr('src', `/img/manufacturing/${e.data.photo_manufacturing_2}`)
                } else {
        ...
        function prosesTambahMaterial(id) {
            $.ajax({
                url: "{{ route('manufacturing-2.store_material') }}",
                method: "POST",
                dataType: 'json',
                data: {
        ...
        function getListMaterial() {
            $.ajax({
                url: `/manufacturing-2/show-material/${temp_sales_order_id}`,
                method: "get",
                dataType: 'json',
                beforeSend: function() {
                    $('#v_material').block({
        ...
        function destroyMaterial(id) {
            $.ajax({
                url: "{{ route('manufacturing-2.destroy-material') }}",
                method: "post",
                dataType: "json",
                data: {
                    id: id,
