    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form-edit').on('submit', e => {
                ...
                $.ajax({
                    url: `/manufacturing-cutting/update/${temp_sales_order_id}`,
                    method: 'post',
                    dataType: 'json',
                    data: formData,
                    processData: false,
        ...
        function askMove(id) {
            Swal.fire({
                title: 'Pindah Data?',
                text: "Anda yakin ingin memindahkan data ini ke Manufacturing Infuse?",
                icon: 'question',
        ...
        function processMove(id) {
            $.ajax({
                url: "/sales-order/move/manufacturing-infuse/" + id,
                method: "POST",
                beforeSend: function() {
                    $.blockUI({
                        message: '<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>',
                ...
                if (e.success) {
                    Swal.fire(
                        ...
                        if (result.isConfirmed) {
                            window.location = "{{ route('manufacturing-cutting') }}"
                        }
                    })
                } else {
                    Swal.fire(
        ...
        function showEdit(id) {
            ...
            $.ajax({
                ...
                if (e.data.photo_manufacturing_cutting) {
                    console.log(e.data.photo_manufacturing_cutting)
                    $('.img-thumbnail').attr('src', `/img/manufacturing/${e.data.photo_manufacturing_cutting}`)
                } else {
        ...
        function prosesTambahMaterial(id) {
            $.ajax({
                url: "{{ route('manufacturing-cutting.store_material') }}",
                method: "POST",
                dataType: 'json',
                data: {
        ...
        function getListMaterial() {
            $.ajax({
                url: `/manufacturing-cutting/show-material/${temp_sales_order_id}`,
                method: "get",
                dataType: 'json',
                beforeSend: function() {
                    $('#v_material').block({
