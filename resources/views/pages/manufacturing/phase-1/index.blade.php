                                        ...
                                        <tbody>
                                            @foreach ($datas as $data)
                                                <tr>
                                                    <td>
                                                        <div class="btn-group">
                                                            @if ($data->revisi_manufacturing_1 > 0)
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#form-edit').on('submit', e => {
                ...
                $.ajax({
                    url: `/manufacturing-1/update/${temp_sales_order_id}`,
                    method: 'post',
                    dataType: 'json',
                    data: formData,
                    processData: false,
        ...
        function askMove(id) {
            Swal.fire({
                title: 'Pindah Data?',
                text: "Anda yakin ingin memindahkan data ini ke Manufacturing Phase 2?",
                icon: 'question',
        ...
        function processMove(id) {
            $.ajax({
                url: "/sales-order/move/manufacturing-2/" + id,
                method: "POST",
                beforeSend: function() {
                    $.blockUI({
                        message: '<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>',
                ...
                if (e.success) {
                    Swal.fire(
                        ...
                        if (result.isConfirmed) {
                            window.location = "{{ route('manufacturing-1') }}"
                        }
                    })
                } else {
                    Swal.fire(
        ...
        function showEdit(id) {
            ...
            $.ajax({
                ...
                if (e.data.photo_manufacturing_1) {
                    console.log(e.data.photo_manufacturing_1)
                    $('.img-thumbnail').attr('src', `/img/manufacturing/${e.data.photo_manufacturing_1}`)
                } else {
        ...
        function prosesTambahMaterial(id) {
            $.ajax({
                url: "{{ route('manufacturing-1.store_material') }}",
                method: "POST",
                dataType: 'json',
                data: {
        ...
        function getListMaterial() {
            $.ajax({
                url: `/manufacturing-1/show-material/${temp_sales_order_id}`,
                method: "get",
                dataType: 'json',
                beforeSend: function() {
                    $('#v_material').block({
